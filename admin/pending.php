    ...
    <div class="page-content contents" style="margin-top: 100px;">
        <div class="row">
            <div class="col-md-2">
                ...
                <li class="current"><a href="pending.php"><i class="glyphicon glyphicon-list"></i>Pending students</a></li>
            ...
            <div class="col-md-10">
                <h3>Pending Students<button class="btn btn-primary" id="refresh" onclick="refresh();" style="float:right;"><span class="glyphicon glyphicon-refresh"> </span>  Refresh Page</button></h3>
                <h5>
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
        <?php 
    $sql = "SELECT * FROM `exeatinfo` WHERE `status`='pending'";
...
?>
                        ...
                        <td><button class="btn btn-success success" id="accept">Accept</button><br><br><button class="btn btn-danger" id="decline">Decline</button></td>
                    </tr>
                <?php endwhile; ?>
                    </table>
                    </div>
