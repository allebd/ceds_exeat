    ...
    <div class="page-content contents" style="margin-top: 100px;">
        <div class="row">
            <div class="col-md-2">
                ...
                <li class="current"><a href="accepted.php"><i class="glyphicon glyphicon-list"></i>Accepted students</a></li>
            ...
            <div class="col-md-10">
                <h3>Accepted Students<button class="btn btn-primary" id="refresh" onclick="refresh();"  style="float:right;"><span class="glyphicon glyphicon-refresh"> </span>  Refresh Page</button></h3>
                <h5>
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            <?php 
    $sql = "SELECT * FROM `exeatinfo` WHERE `status`='accepted'";
...
?>
                        ...
                        <td><?php echo $row[17] ?></td>
                            <td><button class="btn btn-danger" id="decline">Decline</button></td>
                        </tr>
                <?php endwhile; ?>
                    </table>
                    </div>
